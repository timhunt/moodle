...
class grade_calculator {
    ...
    /**
     * @var ?stdClass[] quiz_grade_items for this quiz indexed by id, sorted by sortorder, with a maxmark field added.
     *
    ...
    public function compute_grade_item_totals(question_usage_by_activity $quba): array {
        ...
        foreach ($this->gradeitems as $gradeitem) {
            $grades[$gradeitem->id] = new grade_out_of($this->quizobj->get_quiz(), 0, $gradeitem->maxmark);
