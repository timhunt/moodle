...
class edit_renderer extends \plugin_renderer_base {
    ...
    public function question(structure $structure, int $slot, \moodle_url $pageurl) {
        ...
        if ($structure->can_display_number_be_customised($slot)) {
            ...
            // Highlight the customised question numbers.
            if ($structure->is_display_number_customised($slotid)) {
                $questionnumbercustomised = str_replace("inplaceeditable inplaceeditable-text",
                        "inplaceeditable inplaceeditable-text customisedqno", $questionnumbercustomised);
            }
