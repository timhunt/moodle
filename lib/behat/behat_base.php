...
class behat_base extends Behat\MinkExtension\Context\RawMinkContext {
    ...
    /**
     * Return a list of the deprecated named replacements for the component.
     *
     * This is to support changes in the partial and exact named selectors
     * to help with backwards compatibility. The {@link behat_component_named_replacement}s
     * returned show how the old, deprecated, names translate into the
     * new names that should be used in future.
     *
