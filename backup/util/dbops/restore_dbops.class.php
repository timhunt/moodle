    ...
    */
    ...
    public static function calculate_course_names($courseid, $fullname, $shortname) {
        ...
        do {
            ...
            $currentfullname = core_text::substr($fullname, 0, 1333 - strlen($suffixfull)) . $suffixfull;
            $currentshortname = core_text::substr($shortname, 0, 255 - strlen($suffixshort)) . $suffixshort;
