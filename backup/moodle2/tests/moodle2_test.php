        ...
        foreach ($backupfiles as $backupfile) {
            ...
            foreach ($contexts as $context) {
                ...
                if ($context->contextlevel == CONTEXT_COURSE) {
                    // Course context categories are deprecated and now get transferred to a mod_qbank instance on the course
                    // at point of restore.
                    $cats = $DB->get_records('question_categories', array('contextid' => $qbank->context->id), 'parent', 'id, name, parent');
