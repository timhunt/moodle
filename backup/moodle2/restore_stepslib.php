    ...
    protected function define_execution() {
        ...
        foreach ($contexts as $contextid => $contextlevel) {
            if (!$newcontext = restore_dbops::get_backup_ids_record($this->get_restoreid(), 'context', $contextid)) {
                // Create a default question bank for categories without a module to attach to.
                ...
                $defaultqbank = core_question\sharing\helper::get_default_open_instance_system_type($course, true);
